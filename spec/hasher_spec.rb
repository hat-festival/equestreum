    ...
    context 'verify proof-of-work' do
      context 'search at start-of-hash' do
          ...
          it 'verifies when the search string is present' do
            ...
            expect(described_class.proven hash, string: '0').to be true
          end

          it 'does not verify when the search string is not present' do
            hash = 'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'
            expect(described_class.proven hash, string: '0').to be false
          end
        end
        ...
        context 'two characters' do
          it 'verifies when the search string is present' do
            ...
            expect(described_class.proven hash, string: '01').to be true
          end

          it 'does not verify when the search string is not present' do
            hash = '0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'
            expect(described_class.proven hash, string: '00').to be false
          end
        end
        ...
        context 'eight characters' do
          it 'verifies when the search string is present' do
            ...
            expect(described_class.proven hash, string: '01234567').to be true
          end

          it 'does not verify when the search string is not present' do
            hash = '0123ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'
            expect(described_class.proven hash, string: '01234567').to be false
          end
        end

        context 'widen the search space' do
          context 'find a two-character string inside the first four characters' do
            specify 'hash contains the search string in a valid position' do
              ...
              expect(described_class.proven hash, string: '01', space: 4).to be true
            end
            ...
            specify 'hash contains the search string in a invalid position ' do
              ...
              expect(described_class.proven hash, string: '01', space: 4).to be false
            end

            specify 'hash does not contain the search string' do
              hash = '123fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'
              expect(described_class.proven hash, string: '012', space: 4).to be false
            end
          end
          ...
          context 'find a four-character string inside the first 16 characters' do
            specify 'hash contains the search string in a valid position' do
              ...
              expect(described_class.proven hash, string: '0123', space: 16).to be true
            end

            specify 'hash contains the search string in a invalid position ' do
              hash = 'fffffffffffffff0123fffffffffffffffffffffffffffffffffffffffffffff'
              expect(described_class.proven hash, string: '0123', space: 16).to be false
            end
          ...
          context 'find an eight-character string anywhere' do
            specify 'hash contains the search string in a valid position' do
              ...
              expect(described_class.proven hash, string: '01234567', space: 64).to be true
            end
            ...
            specify 'hash does not contain the search string' do
              ...
              expect(described_class.proven hash, string: '01234567', space: 16).to be false
            end
          end
        end
      end
    ...
    context 'generate hashes' do
      it 'generates a hash' do
        Timecop.freeze EPOCH do
          ...
          expect(described_class.hash nonce, difficulty, previous, data).to eq (
